...
class TrafficResponseModel {
  TrafficResponseModel({
  ...
  factory TrafficResponseModel.fromJson(String str) =>
      TrafficResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory TrafficResponseModel.fromMap(Map<String, dynamic> json) =>
      TrafficResponseModel(
